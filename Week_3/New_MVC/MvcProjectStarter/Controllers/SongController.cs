...
namespace MvcProjectStarter.Controllers
{
    public class SongController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,title,genre,artist,albumName")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,title,genre,artist,albumName")] Song song)
        {
            if (id != song.ID)
            {
                return NotFound();
